    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dogetip Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Dogetip Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dogetip-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dogetip Core is shutting down...") + "<br /><br />" +
