...
// Copyright (c) 2014-2015 The Dogetip Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Dogetip Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dogetip address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dogetip: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Dogetip Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dogetip Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Dogetip Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dogetip addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dogetip addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Dogecoin Core help message to get a list with possible Dogetip command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dogetip Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dogetip network", "", count));
}
...
{
    QString strTitle = tr("Dogetip"); // default title
